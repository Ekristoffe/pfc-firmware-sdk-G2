...
KRB5_BASE	:= 1.20
KRB5_BUGFIX	:= 2
KRB5_VERSION	:= $(KRB5_BASE).$(KRB5_BUGFIX)
KRB5_MD5	:= 7ac456e97c4959ebe5c836dc2f5aab2c
KRB5		:= krb5-$(KRB5_VERSION)
KRB5_SUFFIX	:= tar.gz
KRB5_URL	:= https://web.mit.edu/kerberos/dist/krb5/$(KRB5_BASE)/$(KRB5).$(KRB5_SUFFIX)
...
$(STATEDIR)/krb5.targetinstall:
	...
	@$(call install_lib, krb5, 0, 0, 0644, libkrad)
